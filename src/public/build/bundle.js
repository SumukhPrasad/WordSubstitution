...
var app = (function () {
    ...
    // (9:5) {#if $currentSearchAndResults.search == null}
    function create_if_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(9:5) {#if $currentSearchAndResults.search == null}",
    		ctx
    	});
    ...
    // (12:5) {#each $currentSearchAndResults.content as wordOrPatternArray}
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t10 = text(t10_value);
    			br2 = element("br");
    			add_location(br0, file$1, 12, 46, 402);
    			add_location(br1, file$1, 13, 46, 453);
    			add_location(br2, file$1, 14, 86, 544);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*$currentSearchAndResults*/ 1 && t2_value !== (t2_value = /*wordOrPatternArray*/ ctx[2][0] + "")) set_data_dev(t2, t2_value);
    			if (dirty & /*$currentSearchAndResults*/ 1 && t6_value !== (t6_value = /*wordOrPatternArray*/ ctx[2][1] + "")) set_data_dev(t6, t6_value);

    			if (dirty & /*$currentSearchAndResults*/ 1 && t10_value !== (t10_value = (/*wordOrPatternArray*/ ctx[2][2] == ""
    			? "None."
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(12:5) {#each $currentSearchAndResults.content as wordOrPatternArray}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*$currentSearchAndResults*/ ctx[0].search == null) return create_if_block;
    	...
    	const block = {
    		c: function create() {
    			main = element("main");
    			if_block.c();
    			add_location(main, file$1, 7, 0, 181);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	return [$currentSearchAndResults, schema];
    }
